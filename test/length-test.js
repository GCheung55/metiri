...
require('../definition/length/angstrom')
require('../definition/length/barleycorn')
require('../definition/length/centimeter')
require('../definition/length/chain')
require('../definition/length/cubit')
require('../definition/length/decimeter')
require('../definition/length/digit')
require('../definition/length/ell')
require('../definition/length/fathom')
require('../definition/length/finger')
require('../definition/length/foot')
require('../definition/length/furlong')
require('../definition/length/hand')
require('../definition/length/inch')
require('../definition/length/kilometer')
require('../definition/length/league')
require('../definition/length/line')
require('../definition/length/link')
require('../definition/length/meter')
require('../definition/length/microinch')
require('../definition/length/micrometer')
require('../definition/length/mil')
require('../definition/length/mile')
require('../definition/length/millimeter')
require('../definition/length/nail')
require('../definition/length/nanometer')
// require('../definition/length/nautical-mile')
require('../definition/length/palm')
require('../definition/length/perch')
require('../definition/length/rod')
require('../definition/length/span')
require('../definition/length/survey-foot')
...
testCase('length', {
    ...
    'is a function': function() {
        assert.isFunction(length)
    },

    'returns an object': function() {
        assert.isObject(length())
    },

    'contains definitions': function() {
        var definition = length()._definition
